...
4. expose wrapper in step 3 in syscall.c and register it also with syscall number(step 2) in the table
5. add syscall definition of step 1 in usys.S so linker will find memory reference for declaration in user.h
